...
impl Dimension {
	pub fn formula(&self) -> DimensionFormula {
		...
		match self {
			...
			Frequency => DimensionFormula { num: &[(Scalar, 1)], den: &[(Time, 1)] },
			Area => DimensionFormula { num: &[(Length, 2)], den: &[] },
			Volume => DimensionFormula { num: &[(Length, 3)], den: &[] },

			Velocity => DimensionFormula { num: &[(Length, 1)], den: &[(Time, 1)] },
			Acceleration => DimensionFormula { num: &[(Length, 1)], den: &[(Time, 2)] },
			Jerk => DimensionFormula { num: &[(Length, 1)], den: &[(Time, 3)] },
			Snap => DimensionFormula { num: &[(Length, 1)], den: &[(Time, 4)] },
			Crackle => DimensionFormula { num: &[(Length, 1)], den: &[(Time, 5)] },
			Pop => DimensionFormula { num: &[(Length, 1)], den: &[(Time, 6)] },
			...
			Density => DimensionFormula { num: &[(Mass, 1)], den: &[(Length, 3)] },
			...
			// --- Свет ---
			LuminousFlux => DimensionFormula { num: &[(LuminousIntensity, 1)], den: &[] },
			Illuminance => DimensionFormula {
				num: &[(LuminousIntensity, 1)],
				den: &[(Length, 2)],
			},

			BitRate => DimensionFormula { num: &[(Information, 1)], den: &[(Time, 1)] },

			DataDensity => DimensionFormula { num: &[(Information, 1)], den: &[(Length, 2)] },
